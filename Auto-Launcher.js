...
(()=>{var i=(...a)=>console.log("[WPA-UI]",...a);function q(a=null){let t=document.createElement("div");a&&(t.id=a),t.style.cssText=`
  ...
  `;if(!document.querySelector("#language-selector-styles")){let e=document.createElement("style");e.id="language-selector-styles",e.textContent=d,document.head.appendChild(e)}let o=!1,u=A();function x(){let e=k[u];c.innerHTML=`
